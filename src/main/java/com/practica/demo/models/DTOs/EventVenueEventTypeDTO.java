...
public class EventVenueEventTypeDTO {
    ...
    public EventVenueEventTypeDTO(int eventID, VenueDTO venueDTO, String eventTypeName, String description, Date startDate, Date endDate, List<TicketCategoryDTO> ticketCategories) {
